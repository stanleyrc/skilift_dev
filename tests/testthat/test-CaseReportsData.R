...
test_that("CaseReportsData constructor handles various directory scenarios", {
  ...
  mixed_files <- c(expected_files[1:7], "extra1.json", "extra2.json")
  ...
  expect_warning(
   CaseReportsData$new(base_dir),
    "Missing id_mutation_catalog file in cases: case2, case4"
  )

  expect_warning(
   CaseReportsData$new(base_dir),
    "Missing sbs_decomposed_prob file in cases: case2, case4"
  )
  
  expect_warning(
   CaseReportsData$new(base_dir),
    "Missing id_decomposed_prob file in cases: case2, case4"
  )
